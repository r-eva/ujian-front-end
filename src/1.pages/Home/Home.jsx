...
import {showingId, hitungCart} from '../../redux/1.actions'
...
class Home extends Component {
    ...
    renderProducts = () => {
        let jsx = this.state.productData.map(val => {
            return(
                <ProductBox nama={val.nama} harga={val.harga} discount={val.discount} img={val.img} id={val.id} userId={this.props.id}/>
            )
        })
        return jsx
    }
                    ...
                    <div className="col-lg-3 mt-4">
                        <div className="input-group mb-2">
                            ...
                            <div className="input-group-append">
                                <button className="btn btn-info" type="button" id="button-addon2" onClick={this.props.showingId} >Go</button>
                            </div>
                        </div> 
...
export default connect(mapStateToProps, {showingId, hitungCart})(Home)